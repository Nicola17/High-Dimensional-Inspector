...
Classifier::Classifier(const string& model_file,
  ...
  Caffe::set_mode(Caffe::GPU);
    ...
    for(auto& layer: layers){
        ...
        std::cout << "ExactNumBottomBlobs:\t"<< layer->ExactNumBottomBlobs() << std::endl;
        //std::cout << "MinBottomBlobs:\t"<< layer->MinBottomBlobs() << std::endl;
        //std::cout << "MaxBottomBlobs:\t"<< layer->MaxBottomBlobs() << std::endl;
        std::cout << "ExactNumTopBlobs:\t"<< layer->ExactNumTopBlobs() << std::endl;
        //std::cout << "MinTopBlobs:\t"<< layer->MinTopBlobs() << std::endl;
        //std::cout << "MaxTopBlobs:\t"<< layer->MaxTopBlobs() << std::endl;
      ...
      std::cout << std::endl;
      //std::cout << "ShapeSize:\t"<< params.shape_size() << std::endl;
...
//////////////////////////////////
  //NP TEST
    auto& tv = net_->top_vecs();
    std::cout << "----------------------------" << std::endl;
    std::cout <<  tv.size() << std::endl;
    std::cout <<  tv[0].size() << std::endl;
    std::cout <<  tv[0][0]->shape(1) << std::endl;
    std::cout <<  tv[tv.size()-1][0]->shape(1) << std::endl;
    std::cout << "----------------------------" << std::endl;

    bool ok = true;
    for(int i = 0; i < tv[tv.size()-1][0]->shape(1); ++i){
        std::vector<int> id(2);
        id[0] = 0;
        id[1] = i;
        if(tv[tv.size()-1][0]->data_at(id) != net_->output_blobs()[0]->data_at(id)){
            ok = false;
        }
    }
    if(ok){
        std::cout << "OOOOOOOOK" << std::endl;
    }else{
        std::cout << "WOOOOOOOOOOOOOOOT?!?!?!" << std::endl;
    }
////////////////////////////////
