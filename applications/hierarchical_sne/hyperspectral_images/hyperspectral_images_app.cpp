    ...
    ui(new Ui::hyperspectral_images_app)
{
    ...
    connect(ui->_compute_3d_color_image,&QPushButton::clicked,this,&hyperspectral_images_app::onCompute3DColorImage);
}
...
void hyperspectral_images_app::onCompute3DColorImage(){
