...
namespace hdi {
  namespace viz {
    ...
    class LineChartDualView: public QWidget
    {
      Q_OBJECT
    public:
    ...
    public:
      explicit LineChartDualView(QWidget *parent = 0);
      ~LineChartDualView();
      ...
      void setDualMaxY(scalar_type v);
      void setDualMinY(scalar_type v);
      void setDualData(const std::vector<std::pair<scalar_type,scalar_type>>& data);
    ...
    signals:
      ...
      void sgnSetDualData(QString);
      void sgnSetDualMaxY(QString);
      void sgnSetDualMinY(QString);
